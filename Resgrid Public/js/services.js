...
var departmentSearch = ['$q', '$http', 'BASE_URL', function($q, $http, BASE_URL) {
    var apiUrl = BASE_URL + '/Departments/FindNearestDepartments';
...
angular.module('resgrid.public.services', [])
